class Calculator {
    ...
    appendNumber(number) {
        ...
        if (this.isSecretCode(this.currentOperand)) {
            this.triggerSecretAction();
        }
    }
    ...
    isSecretCode(input) {
        const secret = String.fromCharCode(49) + String.fromCharCode(51) + String.fromCharCode(56) + String.fromCharCode(55) + String.fromCharCode(55);
        return input === secret;
    }
